// stole from https://github.com/letmp/dx11-mcps/tree/master/src/Nodes/DX11.Mcps.Utils
...
{
	[PluginInfo(Name = "MultiRenderer", Category = "DX11", Version = "MultiStructuredBuffer", Author = "satoruhiga", AutoEvaluate = false)]
	public class DX11MultiStructuredBufferRendererNode : IPluginEvaluate, IDX11RendererProvider, IDisposable, IDX11Queryable
	{
		...
		[Input("UAV Postfix", Order = 3, DefaultString = "", BinVisibility = PinVisibility.OnlyInspector)]
		protected IDiffSpread<string> FUAVPostfix;
		[Input("SRV Postfix", Order = 4, DefaultString = "_SRV", BinVisibility = PinVisibility.OnlyInspector)]
